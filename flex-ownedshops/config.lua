...
Config.Shops = {
    ...
    [3] = {
        shopname = 'testi', -- Name of shop
        shopprice = 1000, -- Price of this shop. When it is gang or job owned no need for price
        manageloc = vector4(-170.96, -621.24, 48.24, 298.07), -- Place where you manage the shop
        buyloc = vector4(-167.67, -615.45, 48.23, 194.55), -- Location to buy from shop
        target = false, -- If true it will spawn a vendingmachine at buyloc to target on
        isjob = {
            name = 'dj', -- false to disable job
            everyone = true, -- true if all ranks can access
            dutyloc = vector4(-160.55, -623.74, 48.23, 71.88), -- nil to disable
        },
        isgang = {
            name = false, -- false to disable gang
            everyone = false, -- true if all ranks can access
